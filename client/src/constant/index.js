export const surpriseMePrompts = [
  ...
  "A hamburger in the shape of a Rubik cube, professional food photography",
  ...
  "A post-apocalyptic world where nature has reclaimed urban areas, showing a vine-covered skyscraper",
  "A wizard library filled with floating books, enchanted quills, and luminescent potions",
  "A cybernetic jungle with robotic animals and plants, featuring a digital waterfall",
  "A cosmic chess game between constellations using planets as game pieces, painted in a cosmic art style",
  "An enchanted forest at twilight, where fireflies illuminate the path for fairies and woodland creatures",
  "A surreal underwater tea party hosted by octopuses wearing top hats and monocles",
  "A time-traveling train station with platforms to different historical eras, portrayed in a retro-futuristic style",
  "An underwater city of bioluminescent jellyfish-inspired architecture, with aquatic vehicles and pathways",
  "A floating island city powered by hot air balloons, with intricate steampunk machinery keeping it afloat",
  "A garden of giant, luminescent mushrooms in the middle of an enchanted forest",
  "A superhero market where characters with extraordinary powers exchange goods, depicted in a pop art style",
];
